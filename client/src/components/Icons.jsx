...
// X (formerly Twitter) logo (brand mark, filled). Named to avoid clashing
// with the close/cross XIcon below.
export function XLogoIcon({ size = 16, className = '' }) {
  return (
    <svg
      width={size}
      height={size}
...
// Bluesky logo (brand mark, filled).
export function BlueskyIcon({ size = 16, className = '' }) {
  return (
    <svg
      width={size}
      height={size}
...
// Five-point star (filled). Used for the GitHub star-count badge.
...
// North-east arrow. Used for the "Star here!" hint next to the star count.
